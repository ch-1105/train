  ...
  <a-row class="login">
    <a-col :span="8" :offset="8" class="login-main">
      ...
      >
        ...
        <a-form-item>
          <a-button type="primary" v-if="loginForm.code.length === 4"
           block @click="login">登录</a-button>
          <a-button type="primary" v-else
                    block @click="codeNotVerif">登录</a-button>
        </a-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const sendCode = () => {
      axios.post("http://localhost:8000/member/sendCode", {
    ...
    const codeNotVerif = () => {
      notification.error({ description: '验证码非法！' });
    };
