package com.ch.train.generator.util;
...
public class DbUtil {
    ...
    public static String url = "jdbc:mysql://localhost:3306/train?characterEncoding=UTF8&autoReconnect=true&serverTimezone=Asia/Shanghai";
    public static String username = "train";
    public static String password = "train";
